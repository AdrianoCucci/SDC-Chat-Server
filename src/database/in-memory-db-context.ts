...
export class InMemoryDbContext implements IDbContext {
  ...
  public constructor() {
    ...
    this.users.add({ id: 2, role: RoleType.User, username: "user123", password: "12345", displayName: "Display Name", isOnline: false });
    this.users.add({ id: 3, role: RoleType.User, username: "user456", password: "12345", displayName: "Display Name One", isOnline: false });
    this.users.add({ id: 4, role: RoleType.User, username: "user789", password: "12345", displayName: "Display Name Two", isOnline: false });
    this.users.commit();
  }
}